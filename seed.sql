...
-- Produto_Material (receitas)
-- Sérum Facial (id 1): Ácido Hialurônico + Vitamina C + Água Termal
INSERT INTO produto_material (id_produto, id_material, quantidade_necessaria) VALUES
  (1, 1, 5.000),
  (1, 3, 2.500),
  (1, 5, 50.000);

-- Óleo Capilar (id 2): Óleo de Argan + Extrato de Aloe Vera
INSERT INTO produto_material (id_produto, id_material, quantidade_necessaria) VALUES
  (2, 2, 30.000),
  (2, 6, 20.000);

-- Iluminador Mineral (id 3): Pó de Mica + Vitamina C
INSERT INTO produto_material (id_produto, id_material, quantidade_necessaria) VALUES
  (3, 7, 8.000),
  (3, 3, 1.000);

-- Hidratante Corporal (id 4): Manteiga de Karité + Álcool Cetílico + Aloe Vera
INSERT INTO produto_material (id_produto, id_material, quantidade_necessaria) VALUES
  (4, 4, 40.000),
  (4, 8, 15.000),
  (4, 6, 25.000);

-- Água Micelar (id 5): Água Termal + Aloe Vera
INSERT INTO produto_material (id_produto, id_material, quantidade_necessaria) VALUES
  (5, 5, 80.000),
  (5, 6, 10.000);
...
-- Pedido 3: Hidratante + Água Micelar + Iluminador
INSERT INTO item_pedido (id_pedido, id_produto, quantidade, preco_praticado) VALUES
  (3, 4, 1, 39.90),
  (3, 5, 1, 34.90),
  (3, 3, 1, 49.90);

-- Pedido 4: Iluminador (cancelado)
INSERT INTO item_pedido (id_pedido, id_produto, quantidade, preco_praticado) VALUES
  (4, 3, 1, 49.90);
